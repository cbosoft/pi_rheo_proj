...
\begin{document}
	...
	{\centering\textbf{Last 6 Logs}\\}
	The piezo sensor's output from the last 6 runs were compared as in the figure below. Depending on the run settings, the readings will have a different shape. See the legend on the plot for the details (or, at least, some vague indication of) the run.
