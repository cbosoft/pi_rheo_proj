...
\begin{document}
	...
	Here follows the results of the report generated on 15.08.17 at 14:09. This log is called ``40wtpd0''.
	...
	{\centering\textbf{Last 11 Logs}\\}
	The piezo sensor's output from the last 11 runs were compared as in the figure below. Depending on the run settings, the readings will have a different shape. See the legend on the plot for the details (or, at least, some vague indication of) the run.
	
	{\centering \includegraphics[width=0.4\textwidth]{logs_piezo_compare.png}\\
	\textit{FIG. 3. Raw and Corrected Piezo Plot}\\}
