...
\begin{document}
	...
	\begin{itemize}
		\subsection*{Monday}
		\item Today's To-Do:
		\subitem Test the current sensor
		\subitem Test the ADC (what range does it actually sense?)
		\subitem Use the ADC to get the waveform output from the hall effect sensor (Is it working as expected?)
		\subitem Adjust code to deal with new data logging. Will need to now calc the electrical power sent to the motor.
	\end{itemize}
	\newpage
