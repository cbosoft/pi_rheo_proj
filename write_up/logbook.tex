...
\begin{document}
	...
	\end{itemize}
	\newpage
	\section{Week Beginning 20 February 2017 (Week 5)}
	\begin{itemize}
		\subsection*{Monday}
		\item TODO: Get interval histogram.
		\item Get speed data for every potval using new motor script (maybe is fine now? initial test seems to be a lot less crap)
	\end{itemize}
	\newpage
