...
#plot 1
ax1.set_title(r"$\mathrm{Shear\ Thinning}$")
ax1.plot(x1, y1)
ax1.set_xscale("log")
ax1.set_yscale("log")

#plot 2
ax2.set_title(r"$\mathrm{Shear\ Thickening}$")
ax2.plot(x2, y2)
ax2.set_xscale("log")
ax2.set_yscale("log")

# Set common labels
f.text(0.5, 0.04, r'$\mathrm{Shear\ Stress},\ \sigma\ (Pa)$', ha='center',
va='center')
f.text(0.06, 0.5, r'$\mathrm{Viscosity},\ \mu\ (Pa.s)$', ha='center',
va='center',
rotation='vertical')
