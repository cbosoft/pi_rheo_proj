...
\def\thewords{4842} % last proper build on Wed 08 March 2017 at 11:35:41
...
%	\end{figure}
	...
	\begin{figure}[!htb]
	\centering
	\fbox{\includegraphics[scale=0.5]{images/pi3modelb.png}} %make image more clear
	...
	\section{Rheometry} % last edited 7/3/2017
	...
	The capillary rheometer \cbh \br %(Information about the CR: how does it work, how accurate can it be, what is it usually used for)
	...
	Multiphase suspensions \cbh \br
	Shear thickening: DST \cbh \br
...
%=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++=====------++++++
	...
	\section{Experimental Setup} % last edited 7/3/2017
