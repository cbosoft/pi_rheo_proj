...
\newline \newline \noindent
	...
	A needle attached to a piezo-electric (PEND) is used to detect shear stress at a point within the fluid. When the liquid undergoes jamming, then the needle will move and generate a voltage proportional to the amount it moves. Figure \ref{expdia} gives a diagram of the set-up.\newline
	\begin{figure}[!htb]
	\centering
