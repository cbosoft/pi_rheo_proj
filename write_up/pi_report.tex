...
\def\thewords{10740} % last proper build on Tue 25 April 2017 at 14:52:36
\def\br{\newline \newline \noindent}
\def\hi{\huge{!!!}}
\def\nohi{!!!! \normalsize}
...
\begin{document}
	...
	% Evaluation
	\nc{Evaluation}
	In this chapter, the calibrations and assumptions made throughout are tested for validity, and the rheometer is evaluated against its design criteria.
