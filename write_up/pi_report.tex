...
\newline \newline \noindent\begin{figure}[!htb]
		...
		\begin{subfigure}[t]{0.45\textwidth}
			\centering
			\includegraphics[scale=0.25]{figures/figsenshisto.png}
			\caption{Histogram Plot of \newline Sensor Input Interval Time}
			\label{figsenshisto}
		\end{subfigure}
		\begin{subfigure}[t]{0.45\textwidth}
			\centering
			\includegraphics[scale=0.15]{figures/figspeedvval.png}
